...
fold -w[จำนวนที่ต้องการ] [file]<br>
การจำกัด byte ต่อบรรทัด<br>
fold-b[byteต่อบรรทัด] [file]<br>
จำกัดจำนวนตามตัวอักษรและเกิดขึ้นเมื่อมี whitespace
fold -w[จำนวนบรรทัด] -s [file]<br>
...
แปลงรูปแบบไฟล์<br>
pandoc<br>
* https://opensource.com/article/18/9/intro-pandoc<br>

grep<br>
* https://www.hostinger.com/tutorials/grep-command-in-linux-useful-examples/#:~:text=to%20a%20File-,What%20Is%20the%20grep%20Command%20in%20Linux,see%20which%20lines%20contain%20it.<br>

head<br>
* https://saixiii.com/head-linux-command/#google_vignette<br>
